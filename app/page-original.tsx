...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-zinc-950 dark:bg-zinc-950">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-2 md:gap-6">
              <Link href="/login">
                <Button variant="ghost" className="text-xs md:text-sm font-light tracking-wide px-2 md:px-4">로그인</Button>
              </Link>
              <Link href="/signup">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-12 relative">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-sm md:text-lg lg:text-xl text-center text-zinc-300 leading-relaxed mb-12 md:mb-16 max-w-3xl mx-auto font-normal px-4">
              제품 정보만 입력하면 AI가 타겟 고객을 분석하고,<br className="hidden md:block" />
              <span className="md:hidden"> </span>Thread와 LinkedIn에 최적화된 콘텐츠를 자동으로 생성합니다
            </p>
            ...
            <div className="flex justify-center gap-4 md:gap-6 mb-12 md:mb-20 px-4">
              <Link href="/signup">
                <Button size="lg" className="px-8 md:px-12 group h-12 md:h-14">
                  ...
                  <span className="text-sm md:text-base">시작하기</span>
                </Button>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-12 max-w-3xl mx-auto px-4">
              <div className="text-center group">
                <div className="text-2xl md:text-4xl font-light text-amber-400 mb-2 md:mb-3 group-hover:scale-110 transition-transform duration-300">5분</div>
                <div className="text-xs md:text-sm text-zinc-300 font-medium tracking-wide">빠른 시작</div>
              </div>
              <div className="text-center border-x border-zinc-800 group">
                ...
                <div className="text-xs md:text-sm text-zinc-300 font-medium tracking-wide">자동화</div>
              </div>
              <div className="text-center group">
                ...
                <div className="text-xs md:text-sm text-zinc-300 font-medium tracking-wide">운영</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-32 lg:py-40 border-t border-zinc-800">
        <div className="container mx-auto px-4 md:px-6 lg:px-12">
      ...
      <section className="relative py-16 md:py-32 lg:py-48 border-t border-zinc-800 overflow-hidden">
        {/* Ambient gradient */}
