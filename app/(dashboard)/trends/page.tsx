            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-zinc-400 space-y-1.5">
                  {language === "ko" ? (
                    <>
                      <p className="text-zinc-300 font-medium mb-2">🇰🇷 한국 시장 트렌드 분석:</p>
                      ...
                      <p>• <span className="text-orange-400 font-medium">Reddit</span>: 글로벌 커뮤니티 토론 (한국 관련 서브레딧 포함)</p>
                      <p>• <span className="text-blue-400 font-medium">Twitter/X 한국어</span>: 한국어 트윗 중 높은 참여도를 보이는 실시간 주제</p>
                    </>
                  ) : (
                    <>
                      <p className="text-zinc-300 font-medium mb-2">🌎 US/Global Market Trends:</p>
