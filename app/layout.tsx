...
export default function RootLayout({
  ...
  return (
    <html lang="ko" suppressHydrationWarning>
      ...
      <body
        className={`${inter.variable} ${outfit.variable} font-sans antialiased bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white transition-colors duration-300`}
